...
public class RecursosWeb {
    ...
    private void iniciaListProductos() {
        ...
        switch (tipo) {
            case 0:
                list = SqlEmg.listaProductoFinal("SELECT * FROM electromegusta.producto_final");
                break;
            case 1:
                list = SqlEmg.listaProductoFinal("SELECT * FROM electromegusta.producto_final where id_producto not in(select id_descripcion from electromegusta.descripcion)");
                break;

            case 2:
                list = SqlEmg.listaProductoFinal("SELECT * FROM electromegusta.producto_final where id_producto not in(select id_producto from electromegusta.imagen)");
                break;
        }
    ...
    public void runRefresImage() {
        try {
            ...
            while (it.hasNext()) {
                ...
                recargaImagen(aux.getReferenciaProveedor(), aux.getId());
    ...
    private void asociaTextos() throws SQLException, IOException {
        ...
        while (it.hasNext()) {
            aux = (ProductoFinal) it.next();
            file = buscaArchivoTexto(aux.getReferenciaProveedor());
    ...
    private void asociaTexto(ProductoFinal producto, File file) throws SQLException, IOException {
        String aux;
    ...
    private void creaDescripcion(ProductoFinal producto, String aux) throws SQLException {
        String query;
...
//    }
    ...
    private void asociaImagen() throws SQLException, IOException {
        ...
        while (it.hasNext()) {
            ...
            buscaImagen(aux.getReferenciaProveedor(), aux.getId());
            contador++;
    ...
    private void recargaImagen(String referencia, int idProducto) throws SQLException, IOException {
        File file;
        File aux;
